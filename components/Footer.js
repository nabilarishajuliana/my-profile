...
function Footer() {
    return (
        <>
            <footer className="block px-4 py-4 dark:bg-white-color2 dark:text-gray-400 ">
                <div className="container flex flex-wrap items-center justify-center mx-auto space-y-4 sm:justify-between sm:space-y-0">
                    <div className="flex flex-row pr-3 space-x-4 sm:space-x-8">
                    <div className="py-2 text-sm text-center dark:text-gray-400">Copyright © 2023 HuangResto designed by Nabilarishajuliana</div>
                    </div>
